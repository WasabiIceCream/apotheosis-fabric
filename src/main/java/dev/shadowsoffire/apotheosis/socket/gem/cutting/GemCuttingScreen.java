...
public class GemCuttingScreen extends AdventureContainerScreen<GemCuttingMenu> {
    ...
    public GemCuttingScreen(GemCuttingMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
        // Port note: imageWidth/imageHeight are `final` on this MC version's AbstractContainerScreen,
        // so upstream's post-super `this.imageHeight = 180;` assignment isn't legal here — pass both
        // through the 5-arg super constructor instead (176 is vanilla's default imageWidth).
        super(pMenu, pPlayerInventory, pTitle, 176, 180);
