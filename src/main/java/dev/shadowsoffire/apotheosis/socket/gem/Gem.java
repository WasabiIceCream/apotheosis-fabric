...
public class Gem implements CodecProvider<Gem>, Weighted, Constrained {
    ...
    public static final Codec<Gem> CODEC = RecordCodecBuilder.create(inst -> inst.group(
        ...
        GemBonus.CODEC.listOf().promotePartial(msg -> dev.shadowsoffire.apotheosis.Apotheosis.LOGGER.error("GemBonus decode error: {}", msg)).fieldOf("bonuses").forGetter(Gem::getBonuses),
