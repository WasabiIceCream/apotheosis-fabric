...
public class SimpleTexButton extends Button {
    ...
    protected void extractDefaultLabel(ActiveTextCollector output) {
        ...
        // Port note: this MC version's AbstractWidget has no getFGColor()/UNSET_FG_COLOR concept
        // (removed upstream of NeoForge's copy); text color now comes purely from the Component's
        // own Style, so the manual FG-color override this originally did is dropped.
        this.extractScrollingStringOverContents(output, this.buttonText, 2);
    }
