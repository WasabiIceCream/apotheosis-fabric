 ...
 * <p>
 * This is independent of any {@code loot.modifiers.GlobalLootModifier}s that may apply affix loot into loot tables.
 * <p>
 * Note, this class requires that you go through {@link AffixLootEntry} to create the underlying items.
 * If you want to manage the generation of items yourself, and directly reforge them, use {@code loot.functions.ReforgeItemFunction}.
 */
