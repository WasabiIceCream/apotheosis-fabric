...
public class AugmentingMenu extends BlockEntityMenu<AugmentingTableTile> {
    ...
    public AugmentingMenu(int id, Inventory inv, BlockPos pos) {
        ...
        this.addSlot(new UpdatingSlot(this.tile.getInventory(), 0, 16, 41, stack -> stack.is(Items.SIGIL_OF_ENHANCEMENT)));
    ...
    public boolean clickMenuButton(Player player, int id) {
        ...
        switch (id & 0b1) {
            ...
            case REROLL_BTN -> {
                ...
                ServerPlayNetworking.send((ServerPlayer) this.player, new RerollResultPayload(newAffix));
