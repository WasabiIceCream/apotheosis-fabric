...
/**
 * Port of NeoForge's {@code AffixItemPredicate} (the {@code apotheosis:affixed_item} item
 * sub-predicate — "does this item have at least one affix") — no NeoForge coupling upstream,
 * ported unchanged.
 */
