...
/**
 * Port of NeoForge's {@code RarityItemPredicate} (the {@code apotheosis:item_with_rarity} item
 * sub-predicate — "does this item's rarity fall within this set") — no NeoForge coupling
 * upstream, ported unchanged.
 */
